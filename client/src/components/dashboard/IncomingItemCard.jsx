...
export default function IncomingItemCard({ total = 0, delta = 0 }) {
  const up = delta >= 0;
  return (
    <Box bg="whiteAlpha.100" border="1px solid" borderColor="whiteAlpha.200"
      ...
      <Flex align="center" justify="space-between" mb={2}>
        <Flex align="center" gap={2}>
          <ArrowDownCircle size={22} className="text-green-300" />
          <Text fontWeight="semibold" color="gray.300">Barang Masuk</Text>
        </Flex>
